...
const ConceptsYRelatedNew = (props) => {
  ...
  const x_cui_list = location.state.x_cui_list 
  const z_cui_list = location.state.z_cui_list
...
`
  ...
  //console.log(filterName, filterCui, filterMinPyear, filterMinInstFreq, filterArgRelFreq)   
    return (
      <>
      <ConceptsSelected title="NGS: Closed discovery" subtitle="X Concepts selected" selection={x_cui_list}/>
      <ConceptsSelected subtitle="Z Concepts selected" selection={z_cui_list}/>
      {/*<div>
       <Button
          variant="contained"
          color="primary"
...
export default ConceptsYRelatedNew;
