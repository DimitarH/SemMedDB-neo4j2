...
const ConcTableExtSel = (props) => {
  ...
  const [columns] = useState([
    ...
    }, [data, error, loading, props.name, sorting])
  ...
  const startExport = useCallback(() => {
    ...
    return (
      ...
      <div>
        <TextField id="filterByName" label="Search by name" value={props.name} onChange={handleSearch} variant="outlined" />
      </div>  
...
export default ConcTableExtSel;
