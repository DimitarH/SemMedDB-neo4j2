...
# USAGE: gawk -f semmed4321_arg_rel_min_pyear.awk sub_rel_obj_pyear_edat.txt 
...
#	 			print subject,object,relation, rel[subject][object][relation]["freq"], rel[subject][object][relation]["min"], rel_pyear_list, rel_pfreq_list >"semmed4321_rel_freq_min_pyear_pfreq_srt.txt"; # rel_min_pmid_list, rel_min_sent_id_list, 
				...
				print subject,object,relation, rel[subject][object][relation]["freq"], substr(rel_pyear_list,1,4), rel_pyear_list, rel_pfreq_list >"semmed4321_rel_freq_min_pyear_pfreq_srt.txt"; # rel_min_pmid_list, rel_min_sent_id_list, 
	 		}
	 	}
	 }
